    ...
    public partial class Commande : Form
    {
        ...
        private void AjoutMedicament_Load(object sender, EventArgs e)
        {
         ...
         //   ClsFonctions.Instance.ProprieteDatagrid(Table);
            ...
            fx.Picture_Rond(profil); fx.Picture_Rond(pictureBox2); DataGrid();
            //save.Visible = true;
            panel6.Visible = false;
           // update.Visible = false;
        }
        ClsProprietes.Commande c = new ClsProprietes.Commande();  
        ...
        private void add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Les champs ne doivent pas être vide !", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
                    int qte;
