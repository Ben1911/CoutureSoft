    ...
    public partial class AjoutCategorie : Form
    {
            ...
            if (radioButton1.Checked == true)
            {
            ...
            else if(radioButton2.Checked==true)                    
              {
                try
                {
                    btnSave.Text = "Modifier";
                    id = Table.SelectedCells[0].Value.ToString();
                    personne2.Text = Table.SelectedCells[2].Value.ToString();
        ...
        private void rech_TextChanged(object sender, EventArgs e)
        {
            if(radioButton1.Checked==true)
            {
                try
                {
                    Table.DataSource = d.recherche_UsignSql("select * from Liste_Agent  where id is not null and  Noms LIKE '%" + rech.Text + "%'");
            ...
            if (radioButton2.Checked == true)
            {
                try
                {
                    Table.DataSource = d.recherche_UsignSql("select * from Liste_Patient  where id is not null and  Noms LIKE '%" + rech.Text + "%'");
        ...
        private void rech_MouseMove(object sender, MouseEventArgs e)
        {
